        ...
        <div className="page-content pb-3">
          ...
          <div className="bg-light-2 pt-6 pb-7 mb-6">
            <div className="container">
              ...
              {/* End .title text-center mb-2 */}
              <div className="row">
                <div className="col-sm-6 mx-auto col-lg-3">
                  <div className="member member-2 text-center">
                    ...
                    <div className="member-content">
                      <h3 className="member-title">Manthan Panchal</h3>
                      {/* End .member-title */}
                    </div>
                    {/* End .member-content */}
                  </div>
                ...
                <div className="col-sm-6 mx-auto col-lg-3">
                  <div className="member member-2 text-center">
                    ...
                    {/* End .member-media */}
                    <div className="member-content">
                      <h3 className="member-title">Akshat Panchal</h3>
                      {/* End .member-title */}
                    </div>
                    {/* End .member-content */}
                  </div>
                ...
                <div className="col-sm-6 mx-auto col-lg-3">
                  <div className="member member-2 text-center">
                    ...
                    {/* End .member-media */}
                    <div className="member-content">
                      <h3 className="member-title">Nidhi Rathod</h3>
                      {/* End .member-title */}
                    </div>
                    {/* End .member-content */}
                  </div>
                ...
                <div className="col-sm-6 mx-auto col-lg-3">
                  <div className="member member-2 text-center">
                    ...
                    {/* End .member-media */}
                    <div className="member-content">
                      <h3 className="member-title">Zenith Poriya</h3>
                      {/* End .member-title */}
                    </div>
                    {/* End .member-content */}
                  </div>
                ...
                <div className="col-sm-6  mx-auto col-lg-3">
                  <div className="member member-2 text-center">
                    ...
                    {/* End .member-media */}
                    <div className="member-content">
                      <h3 className="member-title">Prashant Pipaliya</h3>
                      {/* End .member-title */}
                    </div>
                    {/* End .member-content */}
                  </div>
                ...
                <div className="col-sm-6 mx-auto col-lg-3">
                  <div className="member member-2 text-center">
                    ...
                    {/* End .member-media */}
                    <div className="member-content">
                      <h3 className="member-title">Prince Kakadiya</h3>
                      {/* End .member-title */}
                    </div>
                    {/* End .member-content */}
                  </div>
                ...
                <div className="col-sm-6 mx-auto col-lg-3">
                  <div className="member member-2 text-center">
                    ...
                    {/* End .member-media */}
                    <div className="member-content">
                      <h3 className="member-title">Kishan Vasani</h3>
                      {/* End .member-title */}
                    </div>
                    {/* End .member-content */}
                  </div>
